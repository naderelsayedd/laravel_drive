...
@section('content')
    ...
    <h1 class="text-center my-3  text-info">Your Files</h1>
                        ...
                        <tr>
                            ...
                            <th>
                                @if ($item->status == 'private')
                                  <a href="{{route('drive.changeStatus' , $item->id)}}" title="Change Status"><i class="text-danger fa-solid fa-lock"></i></a>
                                @else
                                    <a href="{{route('drive.changeStatus' , $item->id)}}" title="Change Status"><i class="text-primary fa-solid fa-lock-open"></i></a>
                                @endif
                            </th>
                            <th class="actions">
